...
<Tip>Want to edit a real local `.docx` file instead of one living in Drive? See [Dume Docs](/office/docs), part of [Dume Office](/office/overview) (Cowork desktop, beta).</Tip>
