...
icon: "windows"
keywords: ['Microsoft 365','OneDrive','SharePoint','Teams','Planner','To Do','Excel','OneNote','OAuth','automation']
description: "Connect Microsoft 365 to use files, calendar, Teams chat, tasks, notes, and more in Dume."
"og:title": "Microsoft 365 Integration"
"og:description": "Quick Microsoft OAuth and supported non-email actions."
"twitter:card": "summary"
"twitter:title": "Microsoft 365 Integration"
"twitter:description": "Use Microsoft 365 data and actions via chat."
---
...
## 2. Supported Action Categories (Non-Email)

| Category | Examples (Internal Ops) |
| -------- | ----------------------- |
