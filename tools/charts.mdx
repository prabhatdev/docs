...
sidebarTitle: "Charts"
description: "Create interactive pie charts, line charts, and bar charts using @ commands in Dume.ai's chat interface. Learn chart types, customization options, and data visualization best practices."
keywords: ["charts", "data visualization", "pie charts", "line charts", "bar charts", "interactive charts", "data analysis", "business intelligence", "dume.ai tools"]
"og:title": "Interactive Charts - Dume.ai Data Visualization"
"og:description": "Create stunning interactive charts with Dume.ai. Learn to build pie charts, line charts, and bar charts for better data analysis."
"twitter:card": "summary"
"twitter:title": "Charts Tool - Data Visualization with AI"
"twitter:description": "Build interactive charts and visualizations with Dume.ai's powerful charting tools."
---
...
```
 ...
 <Frame>
    <img
        ...
        src="/images/light/artifacts/pie-chart.png"
        alt="pie chart artifact"
        title="Pie Chart artifact usage"
    />
    <img
        className="hidden dark:block"
        src="/images/dark/artifacts/pie-chart.png"
             alt="pie chart artifact"
        title="Pie Chart artifact usage"
    />
</Frame>
...
```
 ...
 <Frame>
    <img
        className="block dark:hidden"
        src="/images/light/artifacts/line-chart.png"
        alt="line chart artifact"
        title="Line Chart artifact usage"
    />
    <img
        className="hidden dark:block"
        src="/images/dark/artifacts/line-chart.png"
         alt="line chart artifact"
        title="Line Chart artifact usage"
    />
</Frame>
...
```
 ...
 <Frame>
    <img
        className="block dark:hidden"
        src="/images/light/artifacts/bar-chart.png"
        alt="bar chart artifact"
        title="Bar Chart artifact usage"
    />
    <img
        className="hidden dark:block"
        src="/images/dark/artifacts/bar-chart.png"
        alt="bar chart artifact"
        title="Bar Chart artifact usage"
    />
</Frame>
