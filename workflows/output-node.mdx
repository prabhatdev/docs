...
sidebarTitle: "Output Node"
icon: "golf-flag-hole"
keywords: ['output node', 'workflow results', 'final output', 'result collection', 'workflow completion', 'data output', 'execution results', 'workflow endpoints']
"og:title": "Output Node - Collect Final Workflow Results"
"og:description": "Learn how to use Output Node in Dume workflows to collect and return final results from your workflow executions."
"twitter:card": "summary"
"twitter:title": "Output Node - Dume Workflows"
"twitter:description": "Collect and return final results from your workflow executions with the Output Node."
---

<Frame>
    <img
        className="block dark:hidden"
        src="/images/light/workflow/sample-nodes/output.png"
        alt="Workflow Dume.ai Output"
        title="Dume.ai Workflow Output"
            width="200"
    />
    <img
        className="hidden dark:block"
        src="/images/dark/workflow/sample_nodes/output.png"
       alt="Workflow Dume.ai Output"
        title="Dume.ai Workflow Output"
            width="200"
    />
...
<Frame>
    <img
        className="block dark:hidden"
        src="/images/light/workflow/nodes/output_node.png"
        alt="Workflow Dume.ai output node"
        title="Dume.ai Workflow Output node"
            width="200"
    />
    <img
        className="hidden dark:block"
        src="/images/dark/workflow/nodes/output_node.png"
      alt="Workflow Dume.ai output node"
        title="Dume.ai Workflow Output node"
            width="200"
    />
