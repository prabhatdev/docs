---
title: "HTTP Node - API Integration for Workflows"
sidebarTitle: "HTTP Node"
description: "Configure and utilize the HTTP Node for seamless API integrations in your Dume.ai workflows. Complete guide to REST API calls, webhooks, and external service connections."
keywords: ['HTTP node', 'API integration', 'REST API', 'webhook calls', 'external services', 'HTTP requests', 'workflow integration', 'API connectivity']
icon: "upload"
"og:title": "HTTP Node - API Integration for Dume.ai Workflows"
"og:description": "Master API integrations with HTTP Node. Configure REST API calls, webhooks, and external service connections in workflows."
"twitter:card": "summary"
"twitter:title": "HTTP Node - API Integration"
"twitter:description": "Seamless API integration for workflows. Connect external services with HTTP requests and webhooks."
---
