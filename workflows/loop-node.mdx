---
title: "Loop Node - Automate Repeated Workflow Actions"
sidebarTitle: "Loop Node"
description: "Automate repeated actions over lists, arrays, and datasets in your workflows using Loop Node. Process multiple items efficiently with batch automation."
keywords: ['loop node', 'batch processing', 'repeated actions', 'workflow loops', 'iteration', 'bulk operations', 'array processing', 'automation efficiency']
icon: "arrow-right-arrow-left"
"og:title": "Loop Node - Automate Repeated Actions in Workflows"
"og:description": "Process multiple items efficiently with Loop Node. Automate repeated actions over lists and arrays in Dume workflows."
"twitter:card": "summary"
"twitter:title": "Loop Node - Batch Automation"
"twitter:description": "Automate repeated actions and process multiple items efficiently with Loop Node. Powerful batch processing."
---
<Frame>
    <img
        className="block dark:hidden"
        src="/images/light/workflow/sample-nodes/loop.png"
        alt="Workflow Dume.ai Loop node"
        title="Dume.ai Workflow Loop node"
            width="200"
    />
    <img
        className="hidden dark:block"
        src="/images/dark/workflow/sample_nodes/loop.png"
       alt="Workflow Dume.ai Loop node"
        title="Dume.ai Workflow Loop node"
            width="200"
    />
...
<Frame>
    <img
        className="block dark:hidden"
        src="/images/light/workflow/nodes/loop_node.png"
        alt="Workflow Dume.ai Loop node"
        title="Dume.ai Workflow Loop node"
            width="200"
    />
    <img
        className="hidden dark:block"
        src="/images/dark/workflow/nodes/loop_node.png"
       alt="Workflow Dume.ai Loop node"
        title="Dume.ai Workflow Loop node"
            width="200"
    />
