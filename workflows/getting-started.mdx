...
<CardGroup cols={2}>
  <Card title="Input Node" icon="sparkles" iconType="regular" color="#NaNNaNNaN" href="/workflows/input-node">
  ...
  <Card title="Condition Node" icon="sparkles" href="/workflows/condition-node">
  ...
  <Card title="Note Node" icon="sparkles" href="/workflows/note-node">
  ...
  <Card title="Tool Node" icon="sparkles" href="/workflows/tool-node">
  ...
  <Card title="Http Node" icon="sparkles" href="/workflows/http-node">
  ...
  <Card title="Code Node" icon="sparkles" href="/workflows/code-node">
  ...
  <Card title="Template Node" icon="sparkles" href="/workflows/template-node">
  ...
  <Card title="Loop Node" icon="sparkles" href="/workflows/loop-node">
  ...
  <Card title="Output Node" icon="sparkles" href="/workflows/output-node">
