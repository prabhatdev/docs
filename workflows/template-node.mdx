...
sidebarTitle: "Template Node"
icon: "align-left"
keywords: ['template node', 'dynamic documents', 'report generation', 'email templates', 'workflow automation', 'data merging', 'document creation', 'templating']
"og:title": "Template Node - Generate Dynamic Documents"
"og:description": "Learn how to use Template Node in Dume workflows to create dynamic documents, reports, and emails by combining text with data."
"twitter:card": "summary"
"twitter:title": "Template Node - Dume Workflows"
"twitter:description": "Generate dynamic documents and reports by combining text templates with workflow data."
---
<Frame>
    <img
        className="block dark:hidden"
        src="/images/light/workflow/sample-nodes/template.png"
        alt="Workflow Dume.ai Template"
        title="Dume.ai Workflow Template"
            width="200"
    />
    <img
        className="hidden dark:block"
        src="/images/dark/workflow/sample_nodes/template.png"
       alt="Workflow Dume.ai Template"
        title="Dume.ai Workflow Template"
            width="200"
    />
...
<Frame>
    <img
        className="block dark:hidden"
        src="/images/light/workflow/nodes/template_node.png"
      alt="Workflow Dume.ai template node"
        title="Dume.ai Workflow Template node"
            width="200"
    />
    <img
        className="hidden dark:block"
        src="/images/dark/workflow/nodes/template_node.png"
      alt="Workflow Dume.ai template node"
        title="Dume.ai Workflow Template node"
            width="200"
    />
...
- **No-Code Setup:** Simple interface means you don’t need advanced coding experience.
 ...
 <Frame>
    <img
        className="block dark:hidden"
        src="/images/light/workflow/nodes/template_node/template_configure.png"
      alt="Workflow Dume.ai template configure"
        title="Dume.ai Workflow Template configure"
            width="200"
    />
    <img
        className="hidden dark:block"
        src="/images/dark/workflow/nodes/template_node/template_configure.png"
      alt="Workflow Dume.ai template configure"
        title="Dume.ai Workflow Template configure"
            width="200"
    />
