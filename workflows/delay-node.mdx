---
title: "Delay Node - Control Workflow Timing"
sidebarTitle: "Delay Node"
icon: "clock"
keywords: ['delay node', 'workflow timing', 'pause workflow', 'timing control', 'rate limiting', 'scheduled delays', 'workflow pacing', 'automation timing']
description: "Control workflow execution timing with Delay Node. Pause workflows for defined periods to manage rate limits, coordinate timing, and control automation pacing."
"og:title": "Delay Node - Control Workflow Timing in Dume.ai"
"og:description": "Master workflow timing control with Delay Node. Pause workflows for defined periods and manage automation pacing effectively."
"twitter:card": "summary"
"twitter:title": "Delay Node - Workflow Timing Control"
"twitter:description": "Control workflow timing and pacing with intelligent delay nodes. Perfect for rate limiting and coordination."
---

<Frame>
    <img
        className="block dark:hidden"
        src="/images/light/workflow/sample-nodes/delay.png"
          alt="Workflow Dume.ai Delay node"
        title="Dume.ai Workflow Delay node"
         width="200"
    />
    <img
        className="hidden dark:block"
        src="/images/dark/workflow/sample_nodes/delay.png"
          alt="Workflow Dume.ai Delay node"
        title="Dume.ai Workflow Delay node"
        width="200"
    />
...
<Frame>
    <img
        className="block dark:hidden"
        src="/images/light/workflow/nodes/delay_node.png"
          alt="Workflow Dume.ai Delay node"
        title="Dume.ai Workflow Delay node"
         width="200"
    />
    <img
        className="hidden dark:block"
        src="/images/dark/workflow/nodes/delay_node.png"
          alt="Workflow Dume.ai Delay node"
        title="Dume.ai Workflow Delay node"
        width="200"
    />
