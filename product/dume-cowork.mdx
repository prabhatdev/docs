...
<Tabs>
  <Tab title="Organize Files" icon="folder-tree">
    ...
    <div className="flex flex-col gap-2 my-6">
      <div className="self-end bg-[#16A34A] text-white px-5 py-3 rounded-2xl rounded-tr-none max-w-[85%] shadow-md">
      ...
      <div className="self-end text-xs text-gray-500 mr-2">Sent to Dume</div>
    </div>
  ...
  <Tab title="Build Spreadsheets" icon="table">
    ...
    <div className="flex flex-col gap-2 my-6">
      <div className="self-end bg-[#16A34A] text-white px-5 py-3 rounded-2xl rounded-tr-none max-w-[85%] shadow-md whitespace-pre-line">
        "Extract data from this folder of receipts and invoices.
        Create a spreadsheet and save it as expense_report_q1.csv"
      </div>
      <div className="self-end text-xs text-gray-500 mr-2">Sent to Dume</div>
    </div>
...
When you are away from your desktop:

1. Send a task from WhatsApp.
2. Dume starts execution on your connected desktop environment.
3. Review progress and outputs when you return.
...
No. Dume CoWork is designed for plain-language task instructions.

### What kind of work is best for CoWork?
File organization, spreadsheet generation, reporting, web-assisted research, and note analysis.

### How is this different from a regular chat AI?
CoWork is task-execution focused: it plans, acts on approved steps, and delivers concrete outputs.
