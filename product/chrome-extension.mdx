...
2. Open Dume from the toolbar (or your keyboard shortcut).
3. Ask for a short summary.
4. Ask one follow-up question.
5. Save or copy the output to your workflow tool.
...
- Confirm you are using the same login method as the web app
### Action buttons not showing on a site
- Some site layouts load slowly; refresh once
- Check that the page is fully loaded before opening Dume

---

<Note>
**Pro Tip:** Start with summary prompts first. Once you trust the outputs, move to advanced tasks like extraction and drafting.
</Note>
