---
title: "MCP Server Integration - Advanced AI Connectivity"
description: "Dume.ai supports seamless integration of remote MCP (Model Context Protocol) servers with just a few clicks. Extend AI capabilities and connect external systems effortlessly."
sidebarTitle: "MCP Servers"
icon: "server"
keywords: ['MCP servers', 'Model Context Protocol', 'remote servers', 'AI integration', 'tool discovery', 'context management', 'state persistence', 'external systems', 'advanced connectivity']
"og:title": "MCP Server Integration - Advanced AI Connectivity with Dume.ai"
"og:description": "Integrate remote MCP servers with Dume.ai for enhanced AI capabilities and seamless external system connections through Model Context Protocol."
"twitter:card": "summary"
"twitter:title": "MCP Server Integration - Dume.ai"
"twitter:description": "Connect MCP servers for advanced AI integration and external system access with Model Context Protocol support."
---
...
<Note>
  You can use https://mcp.composio.dev/dashboard for remote MCP servers
</Note>
