---
title: "MCP Servers"
description: "Dume supports integration of remote MCP servers within few clicks."
sidebarTitle: "MCP Servers"
icon: "server"
keywords: ['MCP servers', 'Model Context Protocol', 'remote servers', 'AI integration', 'tool discovery', 'context management', 'state persistence', 'external systems']
"og:title": "MCP Server Integration - Model Context Protocol Support"
"og:description": "Integrate remote MCP servers with Dume.ai for enhanced AI capabilities and external system connections."
"twitter:card": "summary"
"twitter:title": "MCP Server Integration - Dume.ai"
"twitter:description": "Connect MCP servers for advanced AI integration and external system access with Model Context Protocol."
---
